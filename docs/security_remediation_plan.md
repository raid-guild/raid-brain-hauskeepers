...
The audit findings cluster around two dependency chains:
...
- [walletConnectV2.tsx](/src/lib/legos/fields/walletConnectV2.tsx)
- [WalletConnectLink.tsx](/src/lib/legos/fields/WalletConnectLink.tsx)
- [wagmi-config.ts](/src/lib/wagmi-config.ts)
...
- [decoding.ts](/src/lib/tx-builder/utils/decoding.ts)
- [deepDecoding.ts](/src/lib/tx-builder/utils/deepDecoding.ts)
- [multicall.ts](/src/lib/tx-builder/utils/multicall.ts)
