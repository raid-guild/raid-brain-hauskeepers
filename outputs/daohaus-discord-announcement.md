# DAOhaus Discord Announcement Draft

## Draft Status

DAOhaus-channel draft. Needs review for exact support links, channel names, named owners, and whether Refactory/AI-assisted maintenance should be visible in the community announcement.

## Suggested Visual Asset

- Optional simple graphic: "Clearer support, stronger docs, better maintainer handoff."
...
- The active Admin App has a clearer maintenance path.
...
For community members, the main thing to know is:
