# Refactory As A Human-Governed Maintenance Control Plane: The DAOhaus Case Study

## Working Deck

DAOhaus gave Refactory a live protocol maintenance environment where collaborative AI infrastructure could be tested against real operational complexity: intake, shared context, memory, knowledge, agent assistance, and human review.

## Draft Status

Superprism-channel draft. Needs review for product naming, public architecture details, screenshots, roadmap constraints, and final CTA placement.
...
- Optional public-safe Refactory product screenshot.
...
Need help turning a mature protocol surface into an AI-assisted maintenance environment? Start a raid with Raid Guild: `https://www.raidguild.org/#hire-us`
